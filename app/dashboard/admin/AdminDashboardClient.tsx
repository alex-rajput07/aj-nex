...
export default function AdminDashboardClient({ users }: { users: User[] }) {
    ...
    const kpiData = [
        { title: "Total Students", value: totalStudents, change: "+5%", icon: <Users className="h-6 w-6 text-muted-foreground" /> },
        { title: "Total Teachers", value: totalTeachers, change: "+2", icon: <Users className="h-6 w-6 text-muted-foreground" /> },
        { title: "Total Parents", value: totalParents, change: "+15%", icon: <BookOpen className="h-6 w-6 text-muted-foreground" /> },
